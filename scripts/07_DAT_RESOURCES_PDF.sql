...
if exists ( select 1 from knowledge_resource where id = 1 )
   then
      ...
      set    description = 'Lenguaje', name = 'Lenguaje', resource_type = 'pdf', 
      ...
      values ( 1, now(), 'Lenguaje', 'Lenguaje', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 2 )
   then
      update knowledge_resource
      set    description = 'Lógica', name = 'Lógica', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 2 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 2, now(), 'Lógica', 'Lógica', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 3 )
   then
      update knowledge_resource
      set    description = 'Ejemplo: Declaracion de Tipos de Datos', name = 'Ejemplo: Declaracion de Tipos de Datos', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 3 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 3, now(), 'Ejemplo: Declaracion de Tipos de Datos', 'Ejemplo: Declaracion de Tipos de Datos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 4 )
   then
      update knowledge_resource
      set    description = 'Definición de Conjuntos', name = 'Definición de Conjuntos', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 4 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 4, now(), 'Definición de Conjuntos', 'Definición de Conjuntos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 5 )
   then
      update knowledge_resource
      set    description = 'El predicado Pertenece', name = 'El predicado Pertenece', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 5 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 5, now(), 'El predicado Pertenece', 'El predicado Pertenece', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 6 )
   then
      update knowledge_resource
      set    description = 'Especificación de Conjuntos', name = 'Especificación de Conjuntos', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 6 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 6, now(), 'Especificación de Conjuntos', 'Especificación de Conjuntos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 7 )
   then
      update knowledge_resource
      set    description = 'Inclusión e Igualdad', name = 'Inclusión e Igualdad', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 7 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 7, now(), 'Inclusión e Igualdad', 'Inclusión e Igualdad', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 8 )
   then
      update knowledge_resource
      set    description = 'Construcción de Conjuntos', name = 'Construcción de Conjuntos', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 8 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 8, now(), 'Construcción de Conjuntos', 'Construcción de Conjuntos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 9 )
   then
      update knowledge_resource
      set    description = 'Diagramas de Venn', name = 'Diagramas de Venn', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 9 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 9, now(), 'Diagramas de Venn', 'Diagramas de Venn', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 10 )
   then
      update knowledge_resource
      set    description = 'Conjunto de Partes', name = 'Conjunto de Partes', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 10 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 10, now(), 'Conjunto de Partes', 'Conjunto de Partes', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 11 )
   then
      update knowledge_resource
      set    description = 'Producto Cartesiano', name = 'Producto Cartesiano', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 11 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 11, now(), 'Producto Cartesiano', 'Producto Cartesiano', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 12 )
   then
      update knowledge_resource
      set    description = 'Tipos de Datos en C++', name = 'Tipos de Datos en C++', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 12 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 12, now(), 'Tipos de Datos en C++', 'Tipos de Datos en C++', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 13 )
   then
      update knowledge_resource
      set    description = 'Conectivos Lógicos', name = 'Conectivos Lógicos', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 13 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 13, now(), 'Conectivos Lógicos', 'Conectivos Lógicos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 14 )
   then
      update knowledge_resource
      set    description = 'Lógica y Programación', name = 'Lógica y Programación', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 14 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 14, now(), 'Lógica y Programación', 'Lógica y Programación', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 15 )
   then
      update knowledge_resource
      set    description = 'Modelos y Leyes de Equivalencia', name = 'Modelos y Leyes de Equivalencia', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 15 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 15, now(), 'Modelos y Leyes de Equivalencia', 'Modelos y Leyes de Equivalencia', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 16 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 16, now(), 'lenguajes', 'lenguajes', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 17 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 17, now(), 'ejercicios_sobre_logica', 'ejercicios_sobre_logica', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 21 )
   then
      update knowledge_resource
      set    description = 'Relaciones', name = 'Relaciones', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 21 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 21, now(), 'Relaciones', 'Relaciones', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 22 )
   then
      update knowledge_resource
      set    description = 'Establecimiento de Relaciones', name = 'Establecimiento de Relaciones', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 22 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 22, now(), 'Establecimiento de Relaciones', 'Establecimiento de Relaciones', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 23 )
   then
      update knowledge_resource
      set    description = 'Relacion de Orden', name = 'Relacion de Orden', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 23 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 23, now(), 'Relacion de Orden', 'Relacion de Orden', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 24 )
   then
      update knowledge_resource
      set    description = 'Ejemplo: Propiedades de las relaciones', name = 'Ejemplo: Propiedades de las relaciones', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 24 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 24, now(), 'Ejemplo: Propiedades de las relaciones', 'Ejemplo: Propiedades de las relaciones', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 25 )
   then
      update knowledge_resource
      set    description = 'Definicion Relacion de Orden', name = 'Definicion Relacion de Orden', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 25 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 25, now(), 'Definicion Relacion de Orden', 'Definicion Relacion de Orden', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 26 )
   then
      update knowledge_resource
      set    description = 'Volviendo a las Relaciones en General', name = 'Volviendo a las Relaciones en General', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 26 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 26, now(), 'Volviendo a las Relaciones en General', 'Volviendo a las Relaciones en General', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 27 )
   then
      update knowledge_resource
      set    description = 'Funciones Parciales', name = 'Funciones Parciales', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 27 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 27, now(), 'Funciones Parciales', 'Funciones Parciales', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 28 )
   then
      update knowledge_resource
      set    description = 'Propiedades de las Funciones', name = 'Propiedades de las Funciones', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 28 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 28, now(), 'Propiedades de las Funciones', 'Propiedades de las Funciones', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 29 )
   then
      update knowledge_resource
      set    description = 'Funciones en Programación', name = 'Funciones en Programación', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 29 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 29, now(), 'Funciones en Programación', 'Funciones en Programación', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 30 )
   then
      update knowledge_resource
      set    description = 'Relaciones de Equivalencia', name = 'Relaciones de Equivalencia', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 30 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 30, now(), 'Relaciones de Equivalencia', 'Relaciones de Equivalencia', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 32 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 32, now(), 'ejercicios_sobre_conjuntos', 'ejercicios_sobre_conjuntos', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 36 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 36, now(), 'ejercicios_logica', 'ejercicios_logica', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 37 )
   then
      update knowledge_resource
      set    description = 'Logica de Predicados', name = 'Logica de Predicados', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 37 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 37, now(), 'Logica de Predicados', 'Logica de Predicados', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 38 )
   then
      update knowledge_resource
      set    description = 'Cuantificadores', name = 'Cuantificadores', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 38 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 38, now(), 'Cuantificadores', 'Cuantificadores', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 39 )
   then
      update knowledge_resource
      set    description = 'Ejemplo de Logica de Predicados', name = 'Ejemplo de Logica de Predicados', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 39 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 39, now(), 'Ejemplo de Logica de Predicados', 'Ejemplo de Logica de Predicados', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 40 )
   then
      update knowledge_resource
      set    description = 'Formulacion MatemÃ¡tica - Area del Circulo', name = 'Formulacion MatemÃ¡tica - Area del Circulo', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 40 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 40, now(), 'Formulacion MatemÃ¡tica - Area del Circulo', 'Formulacion MatemÃ¡tica - Area del Circulo', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 41 )
   then
      update knowledge_resource
      set    description = 'Codificacion de Funcion Area del Circulo', name = 'Codificacion de Funcion Area del Circulo', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 41 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 41, now(), 'Codificacion de Funcion Area del Circulo', 'Codificacion de Funcion Area del Circulo', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 42 )
   then
      update knowledge_resource
      set    description = 'Perimetro de un cuadrado', name = 'Perimetro de un cuadrado', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 42 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 42, now(), 'Perimetro de un cuadrado', 'Perimetro de un cuadrado', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 43 )
   then
      update knowledge_resource
      set    description = 'Validacion de Datos', name = 'Validacion de Datos', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 43 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 43, now(), 'Validacion de Datos', 'Validacion de Datos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 44 )
   then
      update knowledge_resource
      set    description = 'Producto Cartesiano Generalizado', name = 'Producto Cartesiano Generalizado', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 44 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 44, now(), 'Producto Cartesiano Generalizado', 'Producto Cartesiano Generalizado', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 45 )
   then
      update knowledge_resource
      set    description = 'Area del Rectangulo', name = 'Area del Rectangulo', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 45 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 45, now(), 'Area del Rectangulo', 'Area del Rectangulo', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 47 )
   then
      update knowledge_resource
      set    description = 'Programando Validaciones', name = 'Programando Validaciones', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 47 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 47, now(), 'Programando Validaciones', 'Programando Validaciones', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 48 )
   then
      update knowledge_resource
      set    description = 'Maximo de dos numeros', name = 'Maximo de dos numeros', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 48 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 48, now(), 'Maximo de dos numeros', 'Maximo de dos numeros', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 49 )
   then
      update knowledge_resource
      set    description = 'Maximo de tres numeros', name = 'Maximo de tres numeros', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 49 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 49, now(), 'Maximo de tres numeros', 'Maximo de tres numeros', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 50 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 50, now(), 'instrucciones', 'instrucciones', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 51 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 51, now(), 'ejercicios_tda', 'ejercicios_tda', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 52 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 52, now(), 'enunciado', 'enunciado', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 55 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 55, now(), 'ejercicios_de_funciones', 'ejercicios_de_funciones', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 56 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 56, now(), 'ejercios_de_funciones_recursivas', 'ejercios_de_funciones_recursivas', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 57 )
   then
      update knowledge_resource
      set    description = 'Asignaciones 1', name = 'Asignaciones 1', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = FALSE
      where id = 57 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 57, now(), 'Asignaciones 1', 'Asignaciones 1', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 58 )
   then
      update knowledge_resource
      set    description = 'Asignaciones 2', name = 'Asignaciones 2', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = FALSE
      where id = 58 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 58, now(), 'Asignaciones 2', 'Asignaciones 2', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 59 )
   then
      update knowledge_resource
      set    description = 'Composición de Funciones', name = 'Composición de Funciones', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = FALSE
      where id = 59 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 59, now(), 'Composición de Funciones', 'Composición de Funciones', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 60 )
   then
      update knowledge_resource
      set    description = 'Definición de Funcion Recursiva', name = 'Definición de Funcion Recursiva', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 60 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 60, now(), 'Definición de Funcion Recursiva', 'Definición de Funcion Recursiva', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 61 )
   then
      update knowledge_resource
      set    description = 'Ciclos II', name = 'Ciclos II', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 61 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 61, now(), 'Ciclos II', 'Ciclos II', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 62 )
   then
      update knowledge_resource
      set    description = 'Flujos de Datos y Persistencia', name = 'Flujos de Datos y Persistencia', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 62 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 62, now(), 'Flujos de Datos y Persistencia', 'Flujos de Datos y Persistencia', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 63 )
   then
      update knowledge_resource
      set    description = 'Arreglos', name = 'Arreglos', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 63 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 63, now(), 'Arreglos', 'Arreglos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 64 )
   then
      update knowledge_resource
      set    description = 'Producto Cartesiano Generalizado y Arreglos', name = 'Producto Cartesiano Generalizado y Arreglos', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 64 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 64, now(), 'Producto Cartesiano Generalizado y Arreglos', 'Producto Cartesiano Generalizado y Arreglos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 65 )
   then
      update knowledge_resource
      set    description = 'Construccion de Arreglos', name = 'Construccion de Arreglos', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 65 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 65, now(), 'Construccion de Arreglos', 'Construccion de Arreglos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 66 )
   then
      update knowledge_resource
      set    description = 'Destruccion de Arreglos', name = 'Destruccion de Arreglos', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 66 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 66, now(), 'Destruccion de Arreglos', 'Destruccion de Arreglos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 67 )
   then
      update knowledge_resource
      set    description = 'Arreglos y Flujos de Datos', name = 'Arreglos y Flujos de Datos', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 67 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 67, now(), 'Arreglos y Flujos de Datos', 'Arreglos y Flujos de Datos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 68 )
   then
      update knowledge_resource
      set    description = 'Utilizacion de Flujos de Datos', name = 'Utilizacion de Flujos de Datos', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 68 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 68, now(), 'Utilizacion de Flujos de Datos', 'Utilizacion de Flujos de Datos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 69 )
   then
      update knowledge_resource
      set    description = 'Asignaciones', name = 'Asignaciones', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 69 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 69, now(), 'Asignaciones', 'Asignaciones', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 70 )
   then
      update knowledge_resource
      set    description = 'Ciclos I', name = 'Ciclos I', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 70 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 70, now(), 'Ciclos I', 'Ciclos I', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 71 )
   then
      update knowledge_resource
      set    description = 'Seleccion', name = 'Seleccion', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 71 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 71, now(), 'Seleccion', 'Seleccion', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 73 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 73, now(), 'Composición de Funciones', 'Composición de Funciones', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 74 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 74, now(), 'Asignaciones 1', 'Asignaciones 1', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 75 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 75, now(), 'Asignaciones 2', 'Asignaciones 2', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 76 )
   then
      update knowledge_resource
      set    description = 'Tipos de Datos Abstractos', name = 'Tipos de Datos Abstractos', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = FALSE
      where id = 76 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 76, now(), 'Tipos de Datos Abstractos', 'Tipos de Datos Abstractos', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 77 )
   then
      update knowledge_resource
      set    description = 'Constructores de TDA', name = 'Constructores de TDA', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 77 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 77, now(), 'Constructores de TDA', 'Constructores de TDA', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 78 )
   then
      update knowledge_resource
      set    description = 'Ejemplo TDA', name = 'Ejemplo TDA', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 78 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 78, now(), 'Ejemplo TDA', 'Ejemplo TDA', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 79 )
   then
      update knowledge_resource
      set    description = 'Liberadoras TDA', name = 'Liberadoras TDA', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 79 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 79, now(), 'Liberadoras TDA', 'Liberadoras TDA', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 80 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 80, now(), 'Tipos de Datos Abstractos', 'Tipos de Datos Abstractos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 81 )
   then
      update knowledge_resource
      set    description = 'Funciones Analizadoras', name = 'Funciones Analizadoras', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 81 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 81, now(), 'Funciones Analizadoras', 'Funciones Analizadoras', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 82 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 82, now(), 'Funciones Analizadoras', 'Funciones Analizadoras', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 83 )
   then
      update knowledge_resource
      set    description = 'Funciones Modificadoras', name = 'Funciones Modificadoras', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 83 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 83, now(), 'Funciones Modificadoras', 'Funciones Modificadoras', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 84 )
   then
      update knowledge_resource
      set    description = 'Otras Funciones de TDA', name = 'Otras Funciones de TDA', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 84 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 84, now(), 'Otras Funciones de TDA', 'Otras Funciones de TDA', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 85 )
   then
      update knowledge_resource
      set    description = 'TDA y Flujos de Datos', name = 'TDA y Flujos de Datos', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 85 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 85, now(), 'TDA y Flujos de Datos', 'TDA y Flujos de Datos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 86 )
   then
      update knowledge_resource
      set    description = 'TDA Estudiante', name = 'TDA Estudiante', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 86 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 86, now(), 'TDA Estudiante', 'TDA Estudiante', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 87 )
   then
      update knowledge_resource
      set    description = 'TDA Estudiante Liberar', name = 'TDA Estudiante Liberar', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 87 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 87, now(), 'TDA Estudiante Liberar', 'TDA Estudiante Liberar', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 88 )
   then
      update knowledge_resource
      set    description = 'TDA Analizadora Estudiante', name = 'TDA Analizadora Estudiante', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 88 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 88, now(), 'TDA Analizadora Estudiante', 'TDA Analizadora Estudiante', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 89 )
   then
      update knowledge_resource
      set    description = 'TDA Modificadoras Estudiante', name = 'TDA Modificadoras Estudiante', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 89 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 89, now(), 'TDA Modificadoras Estudiante', 'TDA Modificadoras Estudiante', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 90 )
   then
      update knowledge_resource
      set    description = 'Lectura TDA Estudiante', name = 'Lectura TDA Estudiante', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 90 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 90, now(), 'Lectura TDA Estudiante', 'Lectura TDA Estudiante', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 91 )
   then
      update knowledge_resource
      set    description = 'Escritura TDA Estudiante', name = 'Escritura TDA Estudiante', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 91 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 91, now(), 'Escritura TDA Estudiante', 'Escritura TDA Estudiante', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 99 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 99, now(), 'ejercicios_matrices', 'ejercicios_matrices', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 111 )
   then
      update knowledge_resource
      set    description = 'Conjuntos Definición', name = 'Conjuntos Definición', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = FALSE
      where id = 111 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 111, now(), 'Conjuntos Definición', 'Conjuntos Definición', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 112 )
   then
      update knowledge_resource
      set    description = 'Definicion de Conjuntos', name = 'Definicion de Conjuntos', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 112 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 112, now(), 'Definicion de Conjuntos', 'Definicion de Conjuntos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 113 )
   then
      update knowledge_resource
      set    description = 'Definición de Elemento', name = 'Definición de Elemento', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 113 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 113, now(), 'Definición de Elemento', 'Definición de Elemento', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 114 )
   then
      update knowledge_resource
      set    description = 'Conjuntos por extensión y por comprensión', name = 'Conjuntos por extensión y por comprensión', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 114 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 114, now(), 'Conjuntos por extensión y por comprensión', 'Conjuntos por extensión y por comprensión', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 115 )
   then
      update knowledge_resource
      set    description = 'Conjunto Vacio', name = 'Conjunto Vacio', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 115 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 115, now(), 'Conjunto Vacio', 'Conjunto Vacio', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 116 )
   then
      update knowledge_resource
      set    description = 'Ejemplos de Inclusión', name = 'Ejemplos de Inclusión', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 116 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 116, now(), 'Ejemplos de Inclusión', 'Ejemplos de Inclusión', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 117 )
   then
      update knowledge_resource
      set    description = 'Inclusion de Conjuntos', name = 'Inclusion de Conjuntos', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 117 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 117, now(), 'Inclusion de Conjuntos', 'Inclusion de Conjuntos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 118 )
   then
      update knowledge_resource
      set    description = 'Representación de Conjuntos con Diagramas de', name = 'Representación de Conjuntos con Diagramas de', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 118 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 118, now(), 'Representación de Conjuntos con Diagramas de', 'Representación de Conjuntos con Diagramas de', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 119 )
   then
      update knowledge_resource
      set    description = 'Conjunto Universal', name = 'Conjunto Universal', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 119 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 119, now(), 'Conjunto Universal', 'Conjunto Universal', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 120 )
   then
      update knowledge_resource
      set    description = 'Igualdad de Conjuntos', name = 'Igualdad de Conjuntos', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 120 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 120, now(), 'Igualdad de Conjuntos', 'Igualdad de Conjuntos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 121 )
   then
      update knowledge_resource
      set    description = 'Unión de Conjuntos', name = 'Unión de Conjuntos', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 121 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 121, now(), 'Unión de Conjuntos', 'Unión de Conjuntos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 122 )
   then
      update knowledge_resource
      set    description = 'Intersección de conjuntos', name = 'Intersección de conjuntos', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 122 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 122, now(), 'Intersección de conjuntos', 'Intersección de conjuntos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 123 )
   then
      update knowledge_resource
      set    description = 'Complemento Relativo', name = 'Complemento Relativo', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 123 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 123, now(), 'Complemento Relativo', 'Complemento Relativo', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 124 )
   then
      update knowledge_resource
      set    description = 'Operaciones entre conjuntos con Diagramas de', name = 'Operaciones entre conjuntos con Diagramas de', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 124 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 124, now(), 'Operaciones entre conjuntos con Diagramas de', 'Operaciones entre conjuntos con Diagramas de', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 125 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 125, now(), 'Conjunto de Partes', 'Conjunto de Partes', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 126 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 126, now(), 'Producto Cartesiano', 'Producto Cartesiano', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 127 )
   then
      update knowledge_resource
      set    description = 'Ejemplo de Producto Cartesiano', name = 'Ejemplo de Producto Cartesiano', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 127 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 127, now(), 'Ejemplo de Producto Cartesiano', 'Ejemplo de Producto Cartesiano', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 128 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 128, now(), 'Producto Cartesiano Generalizado', 'Producto Cartesiano Generalizado', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 129 )
   then
      update knowledge_resource
      set    description = 'Introducción a los lenguajes de programacion', name = 'Introducción a los lenguajes de programacion', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = FALSE
      where id = 129 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 129, now(), 'Introducción a los lenguajes de programacion', 'Introducción a los lenguajes de programacion', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 130 )
   then
      update knowledge_resource
      set    description = 'Identificadores', name = 'Identificadores', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 130 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 130, now(), 'Identificadores', 'Identificadores', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 131 )
   then
      update knowledge_resource
      set    description = 'Ejemplos Identificadores', name = 'Ejemplos Identificadores', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 131 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 131, now(), 'Ejemplos Identificadores', 'Ejemplos Identificadores', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 132 )
   then
      update knowledge_resource
      set    description = 'Variables', name = 'Variables', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 132 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 132, now(), 'Variables', 'Variables', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 133 )
   then
      update knowledge_resource
      set    description = 'Tipos de Datos', name = 'Tipos de Datos', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 133 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 133, now(), 'Tipos de Datos', 'Tipos de Datos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 134 )
   then
      update knowledge_resource
      set    description = 'Tipo de Dato Entero', name = 'Tipo de Dato Entero', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 134 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 134, now(), 'Tipo de Dato Entero', 'Tipo de Dato Entero', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 135 )
   then
      update knowledge_resource
      set    description = 'Tipo de Dato Real', name = 'Tipo de Dato Real', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 135 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 135, now(), 'Tipo de Dato Real', 'Tipo de Dato Real', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 136 )
   then
      update knowledge_resource
      set    description = 'Booleanos', name = 'Booleanos', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 136 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 136, now(), 'Booleanos', 'Booleanos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 137 )
   then
      update knowledge_resource
      set    description = 'Caracteres', name = 'Caracteres', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 137 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 137, now(), 'Caracteres', 'Caracteres', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 138 )
   then
      update knowledge_resource
      set    description = 'Tipo de Dato Entero en C++', name = 'Tipo de Dato Entero en C++', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 138 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 138, now(), 'Tipo de Dato Entero en C++', 'Tipo de Dato Entero en C++', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 146 )
   then
      update knowledge_resource
      set    description = 'Introducción a la lógica', name = 'Introducción a la lógica', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 146 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 146, now(), 'Introducción a la lógica', 'Introducción a la lógica', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 147 )
   then
      update knowledge_resource
      set    description = 'El lenguaje de la logica proposicional', name = 'El lenguaje de la logica proposicional', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 147 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 147, now(), 'El lenguaje de la logica proposicional', 'El lenguaje de la logica proposicional', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 148 )
   then
      update knowledge_resource
      set    description = 'Lexico de la Logica', name = 'Lexico de la Logica', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 148 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 148, now(), 'Lexico de la Logica', 'Lexico de la Logica', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 149 )
   then
      update knowledge_resource
      set    description = 'Sintaxis de la Lógica', name = 'Sintaxis de la Lógica', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 149 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 149, now(), 'Sintaxis de la Lógica', 'Sintaxis de la Lógica', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 150 )
   then
      update knowledge_resource
      set    description = 'Semantica de la Lógica Parte I', name = 'Semantica de la Lógica Parte I', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 150 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 150, now(), 'Semantica de la Lógica Parte I', 'Semantica de la Lógica Parte I', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 151 )
   then
      update knowledge_resource
      set    description = 'Semantica de la Logica Parte II', name = 'Semantica de la Logica Parte II', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 151 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 151, now(), 'Semantica de la Logica Parte II', 'Semantica de la Logica Parte II', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 152 )
   then
      update knowledge_resource
      set    description = 'Semantica de la Lógica Ejemplo', name = 'Semantica de la Lógica Ejemplo', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 152 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 152, now(), 'Semantica de la Lógica Ejemplo', 'Semantica de la Lógica Ejemplo', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 153 )
   then
      update knowledge_resource
      set    description = 'Precedencia de Operadores', name = 'Precedencia de Operadores', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 153 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 153, now(), 'Precedencia de Operadores', 'Precedencia de Operadores', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 154 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 154, now(), 'Precedencia de Operadores', 'Precedencia de Operadores', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 156 )
   then
      update knowledge_resource
      set    description = 'Leyes de la Logica I', name = 'Leyes de la Logica I', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 156 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 156, now(), 'Leyes de la Logica I', 'Leyes de la Logica I', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 157 )
   then
      update knowledge_resource
      set    description = 'Interpretaciones I', name = 'Interpretaciones I', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 157 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 157, now(), 'Interpretaciones I', 'Interpretaciones I', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 158 )
   then
      update knowledge_resource
      set    description = 'Interpretaciones II', name = 'Interpretaciones II', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 158 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 158, now(), 'Interpretaciones II', 'Interpretaciones II', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 159 )
   then
      update knowledge_resource
      set    description = 'Equivalencias Logicas', name = 'Equivalencias Logicas', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 159 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 159, now(), 'Equivalencias Logicas', 'Equivalencias Logicas', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 160 )
   then
      update knowledge_resource
      set    description = 'Tautologias, Contradicciones y Contingencias', name = 'Tautologias, Contradicciones y Contingencias', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 160 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 160, now(), 'Tautologias, Contradicciones y Contingencias', 'Tautologias, Contradicciones y Contingencias', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 161 )
   then
      update knowledge_resource
      set    description = 'Equivalencias Logicas mas Conocidas', name = 'Equivalencias Logicas mas Conocidas', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 161 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 161, now(), 'Equivalencias Logicas mas Conocidas', 'Equivalencias Logicas mas Conocidas', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 162 )
   then
      update knowledge_resource
      set    description = 'Implicaciones Logicas', name = 'Implicaciones Logicas', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 162 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 162, now(), 'Implicaciones Logicas', 'Implicaciones Logicas', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 163 )
   then
      update knowledge_resource
      set    description = 'Implicaciones Logicas II', name = 'Implicaciones Logicas II', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 163 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 163, now(), 'Implicaciones Logicas II', 'Implicaciones Logicas II', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 168 )
   then
      update knowledge_resource
      set    description = 'Logica de Predicados Parte I', name = 'Logica de Predicados Parte I', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 168 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 168, now(), 'Logica de Predicados Parte I', 'Logica de Predicados Parte I', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 169 )
   then
      update knowledge_resource
      set    description = 'Logica de Predicados Parte II', name = 'Logica de Predicados Parte II', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 169 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 169, now(), 'Logica de Predicados Parte II', 'Logica de Predicados Parte II', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 170 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 170, now(), 'Cuantificadores', 'Cuantificadores', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 171 )
   then
      update knowledge_resource
      set    description = 'Semantica de los Cuantificadores', name = 'Semantica de los Cuantificadores', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 171 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 171, now(), 'Semantica de los Cuantificadores', 'Semantica de los Cuantificadores', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 172 )
   then
      update knowledge_resource
      set    description = 'Particularización Universal', name = 'Particularización Universal', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 172 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 172, now(), 'Particularización Universal', 'Particularización Universal', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 173 )
   then
      update knowledge_resource
      set    description = 'Logica de Predicados en Programacion', name = 'Logica de Predicados en Programacion', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 173 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 173, now(), 'Logica de Predicados en Programacion', 'Logica de Predicados en Programacion', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 175 )
   then
      update knowledge_resource
      set    description = 'Operadores', name = 'Operadores', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 175 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 175, now(), 'Operadores', 'Operadores', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 176 )
   then
      update knowledge_resource
      set    description = 'Operadores de Asignacion', name = 'Operadores de Asignacion', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 176 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 176, now(), 'Operadores de Asignacion', 'Operadores de Asignacion', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 177 )
   then
      update knowledge_resource
      set    description = 'Operadores Logicos', name = 'Operadores Logicos', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 177 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 177, now(), 'Operadores Logicos', 'Operadores Logicos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 178 )
   then
      update knowledge_resource
      set    description = 'Operadores Relacionales', name = 'Operadores Relacionales', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 178 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 178, now(), 'Operadores Relacionales', 'Operadores Relacionales', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 179 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 179, now(), 'Precedencia de Operadores', 'Precedencia de Operadores', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 180 )
   then
      update knowledge_resource
      set    description = 'Incremento y Decremento', name = 'Incremento y Decremento', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 180 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 180, now(), 'Incremento y Decremento', 'Incremento y Decremento', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 181 )
   then
      update knowledge_resource
      set    description = 'Precedencia de Operadores II', name = 'Precedencia de Operadores II', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 181 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 181, now(), 'Precedencia de Operadores II', 'Precedencia de Operadores II', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 182 )
   then
      update knowledge_resource
      set    description = 'Evaluacion de secuencias de expresiones', name = 'Evaluacion de secuencias de expresiones', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 182 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 182, now(), 'Evaluacion de secuencias de expresiones', 'Evaluacion de secuencias de expresiones', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 183 )
   then
      update knowledge_resource
      set    description = 'Evaluacion de secuencias de expresiones II', name = 'Evaluacion de secuencias de expresiones II', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 183 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 183, now(), 'Evaluacion de secuencias de expresiones II', 'Evaluacion de secuencias de expresiones II', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 207 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 207, now(), 'ejercicios_cap5', 'ejercicios_cap5', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 208 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 208, now(), 'ejercicios_cap6', 'ejercicios_cap6', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 209 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 209, now(), 'ejercicios_cap7', 'ejercicios_cap7', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 216 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 216, now(), 'ejercicios_cap4', 'ejercicios_cap4', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 221 )
   then
      update knowledge_resource
      set    description = 'Traza de un programa', name = 'Traza de un programa', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 221 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 221, now(), 'Traza de un programa', 'Traza de un programa', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 222 )
   then
      update knowledge_resource
      set    description = '1. Definicion de Relación', name = '1. Definicion de Relación', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 222 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 222, now(), '1. Definicion de Relación', '1. Definicion de Relación', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 223 )
   then
      update knowledge_resource
      set    description = '2. Dominio y Rango', name = '2. Dominio y Rango', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 223 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 223, now(), '2. Dominio y Rango', '2. Dominio y Rango', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 224 )
   then
      update knowledge_resource
      set    description = '3. Observación sobre las relaciones', name = '3. Observación sobre las relaciones', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 224 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 224, now(), '3. Observación sobre las relaciones', '3. Observación sobre las relaciones', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 225 )
   then
      update knowledge_resource
      set    description = '4. Diagrama Sagital', name = '4. Diagrama Sagital', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 225 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 225, now(), '4. Diagrama Sagital', '4. Diagrama Sagital', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 226 )
   then
      update knowledge_resource
      set    description = '5.Relaciones sobre el mismo conjunto', name = '5.Relaciones sobre el mismo conjunto', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 226 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 226, now(), '5.Relaciones sobre el mismo conjunto', '5.Relaciones sobre el mismo conjunto', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 227 )
   then
      update knowledge_resource
      set    description = '6.Propiedades de las relaciones', name = '6.Propiedades de las relaciones', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 227 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 227, now(), '6.Propiedades de las relaciones', '6.Propiedades de las relaciones', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 228 )
   then
      update knowledge_resource
      set    description = '7.Ejemplo de Propiedades de las Relaciones', name = '7.Ejemplo de Propiedades de las Relaciones', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 228 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 228, now(), '7.Ejemplo de Propiedades de las Relaciones', '7.Ejemplo de Propiedades de las Relaciones', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 229 )
   then
      update knowledge_resource
      set    description = '8.SimetrÃ­a y AntisimetrÃ­a', name = '8.SimetrÃ­a y AntisimetrÃ­a', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 229 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 229, now(), '8.SimetrÃ­a y AntisimetrÃ­a', '8.SimetrÃ­a y AntisimetrÃ­a', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 230 )
   then
      update knowledge_resource
      set    description = '9.Relaciones de Orden', name = '9.Relaciones de Orden', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 230 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 230, now(), '9.Relaciones de Orden', '9.Relaciones de Orden', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 231 )
   then
      update knowledge_resource
      set    description = '10.Funciones Parciales I', name = '10.Funciones Parciales I', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 231 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 231, now(), '10.Funciones Parciales I', '10.Funciones Parciales I', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 232 )
   then
      update knowledge_resource
      set    description = '11.Funciones Parciales II', name = '11.Funciones Parciales II', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 232 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 232, now(), '11.Funciones Parciales II', '11.Funciones Parciales II', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 233 )
   then
      update knowledge_resource
      set    description = 'Tipo de Dato Booleano en C++', name = 'Tipo de Dato Booleano en C++', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 233 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 233, now(), 'Tipo de Dato Booleano en C++', 'Tipo de Dato Booleano en C++', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 234 )
   then
      update knowledge_resource
      set    description = 'Tipo de Dato Real en C++', name = 'Tipo de Dato Real en C++', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 234 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 234, now(), 'Tipo de Dato Real en C++', 'Tipo de Dato Real en C++', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 235 )
   then
      update knowledge_resource
      set    description = 'Tipo de Dato Caracter en C++', name = 'Tipo de Dato Caracter en C++', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 235 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 235, now(), 'Tipo de Dato Caracter en C++', 'Tipo de Dato Caracter en C++', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 237 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 237, now(), 'Operadores Aritmeticos en C++', 'Operadores Aritmeticos en C++', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 238 )
   then
      update knowledge_resource
      set    description = 'Operadores de Asignacion en C++', name = 'Operadores de Asignacion en C++', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 238 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 238, now(), 'Operadores de Asignacion en C++', 'Operadores de Asignacion en C++', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 241 )
   then
      update knowledge_resource
      set    description = 'Inyectividad', name = 'Inyectividad', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 241 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 241, now(), 'Inyectividad', 'Inyectividad', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 242 )
   then
      update knowledge_resource
      set    description = 'Sobreyectividad', name = 'Sobreyectividad', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 242 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 242, now(), 'Sobreyectividad', 'Sobreyectividad', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 243 )
   then
      update knowledge_resource
      set    description = 'Funcion Total', name = 'Funcion Total', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 243 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 243, now(), 'Funcion Total', 'Funcion Total', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 244 )
   then
      update knowledge_resource
      set    description = 'Biyectividad', name = 'Biyectividad', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 244 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 244, now(), 'Biyectividad', 'Biyectividad', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 245 )
   then
      update knowledge_resource
      set    description = 'Funciones importantes en Programación', name = 'Funciones importantes en Programación', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 245 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 245, now(), 'Funciones importantes en Programación', 'Funciones importantes en Programación', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 246 )
   then
      update knowledge_resource
      set    description = 'Funciones importantes en Programación II', name = 'Funciones importantes en Programación II', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 246 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 246, now(), 'Funciones importantes en Programación II', 'Funciones importantes en Programación II', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 252 )
   then
      update knowledge_resource
      set    description = 'Funcion Raiz Cuadrada', name = 'Funcion Raiz Cuadrada', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 252 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 252, now(), 'Funcion Raiz Cuadrada', 'Funcion Raiz Cuadrada', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 253 )
   then
      update knowledge_resource
      set    description = 'Funcion Logaritmo', name = 'Funcion Logaritmo', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 253 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 253, now(), 'Funcion Logaritmo', 'Funcion Logaritmo', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 254 )
   then
      update knowledge_resource
      set    description = 'Piso, Techo y Parte Entera', name = 'Piso, Techo y Parte Entera', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 254 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 254, now(), 'Piso, Techo y Parte Entera', 'Piso, Techo y Parte Entera', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 255 )
   then
      update knowledge_resource
      set    description = 'Parte Fraccionaria y Redondeo', name = 'Parte Fraccionaria y Redondeo', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 255 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 255, now(), 'Parte Fraccionaria y Redondeo', 'Parte Fraccionaria y Redondeo', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 256 )
   then
      update knowledge_resource
      set    description = 'Composicion de Funciones I', name = 'Composicion de Funciones I', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 256 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 256, now(), 'Composicion de Funciones I', 'Composicion de Funciones I', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 257 )
   then
      update knowledge_resource
      set    description = 'Composicion de Funciones II', name = 'Composicion de Funciones II', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 257 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 257, now(), 'Composicion de Funciones II', 'Composicion de Funciones II', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 258 )
   then
      update knowledge_resource
      set    description = 'Composicion de Funciones III', name = 'Composicion de Funciones III', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 258 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 258, now(), 'Composicion de Funciones III', 'Composicion de Funciones III', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 259 )
   then
      update knowledge_resource
      set    description = 'Ejemplo de Composicion de Funciones', name = 'Ejemplo de Composicion de Funciones', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 259 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 259, now(), 'Ejemplo de Composicion de Funciones', 'Ejemplo de Composicion de Funciones', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 260 )
   then
      update knowledge_resource
      set    description = 'Evaluacion de expresiones con composicion', name = 'Evaluacion de expresiones con composicion', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 260 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 260, now(), 'Evaluacion de expresiones con composicion', 'Evaluacion de expresiones con composicion', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 271 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 271, now(), 'ejercicios_cap7', 'ejercicios_cap7', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 274 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 274, now(), 'ejercicios_cap7', 'ejercicios_cap7', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 281 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 281, now(), 'ejercicios_cap8', 'ejercicios_cap8', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 283 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 283, now(), 'ejercicios_cap10', 'ejercicios_cap10', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 285 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 285, now(), 'ejercicios_cap9', 'ejercicios_cap9', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 287 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 287, now(), 'ejercicios_cap11', 'ejercicios_cap11', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 295 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 295, now(), 'Lenguaje', 'Lenguaje', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 298 )
   then
      update knowledge_resource
      set    description = 'Historia de Las Computadoras', name = 'Historia de Las Computadoras', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 298 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 298, now(), 'Historia de Las Computadoras', 'Historia de Las Computadoras', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 299 )
   then
      update knowledge_resource
      set    description = 'Practica I', name = 'Practica I', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 299 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 299, now(), 'Practica I', 'Practica I', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 300 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 300, now(), 'El lenguaje de la logica proposicional', 'El lenguaje de la logica proposicional', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 301 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 301, now(), 'Introducción a la lógica', 'Introducción a la lógica', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 302 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 302, now(), 'Lexico de la Logica', 'Lexico de la Logica', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 303 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 303, now(), 'Sintaxis de la Lógica', 'Sintaxis de la Lógica', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 304 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 304, now(), 'Semantica de la Lógica Parte I', 'Semantica de la Lógica Parte I', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 305 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 305, now(), 'Semantica de la Logica Parte II', 'Semantica de la Logica Parte II', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 306 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 306, now(), 'Semantica de la Lógica Ejemplo', 'Semantica de la Lógica Ejemplo', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 307 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 307, now(), 'Precedencia de Operadores', 'Precedencia de Operadores', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 308 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 308, now(), 'Leyes de la Logica I', 'Leyes de la Logica I', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 309 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 309, now(), 'Leyes de la Logica I', 'Leyes de la Logica I', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 310 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 310, now(), 'Interpretaciones I', 'Interpretaciones I', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 311 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 311, now(), 'Interpretaciones II', 'Interpretaciones II', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 312 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 312, now(), 'Tautologias, Contradicciones y Contingencias', 'Tautologias, Contradicciones y Contingencias', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 313 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 313, now(), 'Equivalencias Logicas', 'Equivalencias Logicas', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 314 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 314, now(), 'Equivalencias Logicas mas Conocidas', 'Equivalencias Logicas mas Conocidas', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 315 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 315, now(), 'Implicaciones Logicas', 'Implicaciones Logicas', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 316 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 316, now(), 'Implicaciones Logicas II', 'Implicaciones Logicas II', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 317 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 317, now(), 'Logica de Predicados Parte I', 'Logica de Predicados Parte I', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 318 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 318, now(), 'Logica de Predicados Parte II', 'Logica de Predicados Parte II', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 319 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 319, now(), 'Cuantificadores', 'Cuantificadores', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 320 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 320, now(), 'Semantica de los Cuantificadores', 'Semantica de los Cuantificadores', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 321 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 321, now(), 'Particularización Universal', 'Particularización Universal', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 322 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 322, now(), 'Logica de Predicados en Programacion', 'Logica de Predicados en Programacion', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 323 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 323, now(), 'Semantica de la Lógica Ejemplo', 'Semantica de la Lógica Ejemplo', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 324 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 324, now(), 'Semantica de la Lógica Ejemplo', 'Semantica de la Lógica Ejemplo', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 329 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 329, now(), 'ejercicios_logica', 'ejercicios_logica', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 330 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 330, now(), 'Definicion de Conjuntos', 'Definicion de Conjuntos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 331 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 331, now(), 'Definicion de Conjuntos', 'Definicion de Conjuntos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 332 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 332, now(), 'Definición de Elemento', 'Definición de Elemento', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 333 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 333, now(), 'Conjuntos por extensión y por comprensión', 'Conjuntos por extensión y por comprensión', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 334 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 334, now(), 'Conjunto Vacio', 'Conjunto Vacio', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 335 )
   then
      update knowledge_resource
      set    description = 'Rep Conjuntos con Diagramas de Venn', name = 'Rep Conjuntos con Diagramas de Venn', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 335 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 335, now(), 'Rep Conjuntos con Diagramas de Venn', 'Rep Conjuntos con Diagramas de Venn', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 336 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 336, now(), 'Inclusion de Conjuntos', 'Inclusion de Conjuntos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 337 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 337, now(), 'Ejemplos de Inclusión', 'Ejemplos de Inclusión', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 338 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 338, now(), 'Conjunto Universal', 'Conjunto Universal', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 339 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 339, now(), 'Igualdad de Conjuntos', 'Igualdad de Conjuntos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 340 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 340, now(), 'Unión de Conjuntos', 'Unión de Conjuntos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 341 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 341, now(), 'Intersección de conjuntos', 'Intersección de conjuntos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 342 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 342, now(), 'Complemento Relativo', 'Complemento Relativo', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 343 )
   then
      update knowledge_resource
      set    description = 'Operaciones con Diagramas de Venn', name = 'Operaciones con Diagramas de Venn', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 343 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 343, now(), 'Operaciones con Diagramas de Venn', 'Operaciones con Diagramas de Venn', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 344 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 344, now(), 'Conjunto de Partes', 'Conjunto de Partes', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 345 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 345, now(), 'Producto Cartesiano', 'Producto Cartesiano', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 346 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 346, now(), 'Ejemplo de Producto Cartesiano', 'Ejemplo de Producto Cartesiano', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 347 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 347, now(), 'Producto Cartesiano Generalizado', 'Producto Cartesiano Generalizado', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 350 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 350, now(), 'ejercicios_conjuntos', 'ejercicios_conjuntos', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 351 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 351, now(), 'Identificadores', 'Identificadores', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 352 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 352, now(), 'Ejemplos Identificadores', 'Ejemplos Identificadores', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 353 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 353, now(), 'Variables', 'Variables', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 354 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 354, now(), 'Tipos de Datos', 'Tipos de Datos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 355 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 355, now(), 'Tipo de Dato Entero', 'Tipo de Dato Entero', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 356 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 356, now(), 'Tipo de Dato Real', 'Tipo de Dato Real', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 357 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 357, now(), 'Booleanos', 'Booleanos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 358 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 358, now(), 'Caracteres', 'Caracteres', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 359 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 359, now(), 'Tipo de Dato Entero en C++', 'Tipo de Dato Entero en C++', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 360 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 360, now(), 'Tipo de Dato Booleano en C++', 'Tipo de Dato Booleano en C++', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 361 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 361, now(), 'Tipo de Dato Real en C++', 'Tipo de Dato Real en C++', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 362 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 362, now(), 'Tipo de Dato Caracter en C++', 'Tipo de Dato Caracter en C++', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 363 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 363, now(), 'Operadores', 'Operadores', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 364 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 364, now(), 'Operadores de Asignacion', 'Operadores de Asignacion', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 365 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 365, now(), 'Incremento y Decremento', 'Incremento y Decremento', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 366 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 366, now(), 'Operadores Aritmeticos en C++', 'Operadores Aritmeticos en C++', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 367 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 367, now(), 'Operadores de Asignacion en C++', 'Operadores de Asignacion en C++', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 368 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 368, now(), 'Operadores Logicos', 'Operadores Logicos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 369 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 369, now(), 'Operadores Relacionales', 'Operadores Relacionales', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 370 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 370, now(), 'Precedencia de Operadores', 'Precedencia de Operadores', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 371 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 371, now(), 'Precedencia de Operadores II', 'Precedencia de Operadores II', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 372 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 372, now(), 'Evaluacion de secuencias de expresiones', 'Evaluacion de secuencias de expresiones', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 373 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 373, now(), 'Evaluacion de secuencias de expresiones II', 'Evaluacion de secuencias de expresiones II', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 374 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 374, now(), 'Traza de un programa', 'Traza de un programa', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 378 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 378, now(), 'ejercicios_cap_matrices', 'ejercicios_cap_matrices', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 381 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 381, now(), 'ejercicios_cap_arreglos', 'ejercicios_cap_arreglos', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 383 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 383, now(), 'ejercicios_cap_ciclos', 'ejercicios_cap_ciclos', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 385 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 385, now(), 'ejercicios_cap_recursion', 'ejercicios_cap_recursion', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 388 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 388, now(), 'Identificadores', 'Identificadores', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 389 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 389, now(), 'ejercicios_cap_flujos', 'ejercicios_cap_flujos', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 390 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 390, now(), 'Ejemplos Identificadores', 'Ejemplos Identificadores', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 391 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 391, now(), 'Variables', 'Variables', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 392 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 392, now(), 'Tipos de Datos', 'Tipos de Datos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 393 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 393, now(), 'Tipo de Dato Entero', 'Tipo de Dato Entero', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 394 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 394, now(), 'Tipo de Dato Real', 'Tipo de Dato Real', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 395 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 395, now(), 'Booleanos', 'Booleanos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 396 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 396, now(), 'Caracteres', 'Caracteres', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 398 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 398, now(), 'Tipo de Dato Entero en C++', 'Tipo de Dato Entero en C++', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 399 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 399, now(), 'Tipo de Dato Booleano en C++', 'Tipo de Dato Booleano en C++', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 400 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 400, now(), 'Tipo de Dato Real en C++', 'Tipo de Dato Real en C++', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 401 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 401, now(), 'ejercicios_cap_relaciones_y_funciones', 'ejercicios_cap_relaciones_y_funciones', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 402 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 402, now(), 'Tipo de Dato Caracter en C++', 'Tipo de Dato Caracter en C++', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 404 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 404, now(), 'ejercicios_cap_funciones_en_programacion', 'ejercicios_cap_funciones_en_programacion', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 405 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 405, now(), 'Operadores', 'Operadores', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 406 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 406, now(), 'Operadores de Asignacion', 'Operadores de Asignacion', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 407 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 407, now(), 'Incremento y Decremento', 'Incremento y Decremento', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 408 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 408, now(), 'Operadores Aritmeticos en C++', 'Operadores Aritmeticos en C++', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 409 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 409, now(), 'Operadores de Asignacion en C++', 'Operadores de Asignacion en C++', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 410 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 410, now(), 'Operadores Logicos', 'Operadores Logicos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 411 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 411, now(), 'Operadores Relacionales', 'Operadores Relacionales', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 412 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 412, now(), 'Precedencia de Operadores', 'Precedencia de Operadores', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 413 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 413, now(), 'Precedencia de Operadores II', 'Precedencia de Operadores II', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 415 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 415, now(), 'Evaluacion de secuencias de expresiones', 'Evaluacion de secuencias de expresiones', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 416 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 416, now(), 'ejercicios_cap_matrices', 'ejercicios_cap_matrices', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 417 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 417, now(), 'Evaluacion de secuencias de expresiones II', 'Evaluacion de secuencias de expresiones II', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 418 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 418, now(), 'Traza de un programa', 'Traza de un programa', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 422 )
   then
      update knowledge_resource
      set    description = 'Definicion de Relación', name = 'Definicion de Relación', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 422 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 422, now(), 'Definicion de Relación', 'Definicion de Relación', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 423 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 423, now(), 'Definicion de Relación', 'Definicion de Relación', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 424 )
   then
      update knowledge_resource
      set    description = 'Dominio y Rango', name = 'Dominio y Rango', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 424 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 424, now(), 'Dominio y Rango', 'Dominio y Rango', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 425 )
   then
      update knowledge_resource
      set    description = 'Observación sobre las relaciones', name = 'Observación sobre las relaciones', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 425 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 425, now(), 'Observación sobre las relaciones', 'Observación sobre las relaciones', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 426 )
   then
      update knowledge_resource
      set    description = 'Relaciones sobre el mismo conjunto', name = 'Relaciones sobre el mismo conjunto', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 426 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 426, now(), 'Relaciones sobre el mismo conjunto', 'Relaciones sobre el mismo conjunto', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 427 )
   then
      update knowledge_resource
      set    description = 'Propiedades de las relaciones', name = 'Propiedades de las relaciones', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 427 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 427, now(), 'Propiedades de las relaciones', 'Propiedades de las relaciones', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 428 )
   then
      update knowledge_resource
      set    description = 'Ejemplo de Propiedades de las Relaciones', name = 'Ejemplo de Propiedades de las Relaciones', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 428 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 428, now(), 'Ejemplo de Propiedades de las Relaciones', 'Ejemplo de Propiedades de las Relaciones', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 429 )
   then
      update knowledge_resource
      set    description = 'SimetrÃ­a y AntisimetrÃ­a', name = 'SimetrÃ­a y AntisimetrÃ­a', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 429 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 429, now(), 'SimetrÃ­a y AntisimetrÃ­a', 'SimetrÃ­a y AntisimetrÃ­a', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 430 )
   then
      update knowledge_resource
      set    description = 'Relaciones de Orden', name = 'Relaciones de Orden', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 430 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 430, now(), 'Relaciones de Orden', 'Relaciones de Orden', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 431 )
   then
      update knowledge_resource
      set    description = 'Funciones Parciales I', name = 'Funciones Parciales I', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 431 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 431, now(), 'Funciones Parciales I', 'Funciones Parciales I', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 432 )
   then
      update knowledge_resource
      set    description = 'Funciones Parciales II', name = 'Funciones Parciales II', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 432 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 432, now(), 'Funciones Parciales II', 'Funciones Parciales II', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 433 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 433, now(), 'Inyectividad', 'Inyectividad', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 434 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 434, now(), 'Sobreyectividad', 'Sobreyectividad', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 435 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 435, now(), 'Funcion Total', 'Funcion Total', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 436 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 436, now(), 'Biyectividad', 'Biyectividad', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 437 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 437, now(), 'Funciones importantes en Programación', 'Funciones importantes en Programación', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 438 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 438, now(), 'Funciones importantes en Programación II', 'Funciones importantes en Programación II', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 439 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 439, now(), 'Funcion Raiz Cuadrada', 'Funcion Raiz Cuadrada', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 440 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 440, now(), 'Funcion Logaritmo', 'Funcion Logaritmo', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 441 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 441, now(), 'Piso, Techo y Parte Entera', 'Piso, Techo y Parte Entera', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 442 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 442, now(), 'Parte Fraccionaria y Redondeo', 'Parte Fraccionaria y Redondeo', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 443 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 443, now(), 'Parte Fraccionaria y Redondeo', 'Parte Fraccionaria y Redondeo', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 444 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 444, now(), 'Composicion de Funciones I', 'Composicion de Funciones I', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 445 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 445, now(), 'Composicion de Funciones II', 'Composicion de Funciones II', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 446 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 446, now(), 'Composicion de Funciones III', 'Composicion de Funciones III', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 447 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 447, now(), 'Ejemplo de Composicion de Funciones', 'Ejemplo de Composicion de Funciones', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 448 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 448, now(), 'Evaluacion de expresiones con composicion', 'Evaluacion de expresiones con composicion', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 449 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 449, now(), 'Definición de Funcion Recursiva', 'Definición de Funcion Recursiva', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 450 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 450, now(), 'Flujos de Datos y Persistencia', 'Flujos de Datos y Persistencia', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 451 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 451, now(), 'Flujos de Datos y Persistencia', 'Flujos de Datos y Persistencia', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 452 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 452, now(), 'Utilizacion de Flujos de Datos', 'Utilizacion de Flujos de Datos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 453 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 453, now(), 'Seleccion', 'Seleccion', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 454 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 454, now(), 'Seleccion', 'Seleccion', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 455 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 455, now(), 'Ciclos I', 'Ciclos I', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 456 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 456, now(), 'Ciclos II', 'Ciclos II', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 457 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 457, now(), 'Arreglos', 'Arreglos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 458 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 458, now(), 'Producto Cartesiano Generalizado y Arreglos', 'Producto Cartesiano Generalizado y Arreglos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 459 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 459, now(), 'Construccion de Arreglos', 'Construccion de Arreglos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 460 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 460, now(), 'Destruccion de Arreglos', 'Destruccion de Arreglos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 461 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 461, now(), 'Arreglos y Flujos de Datos', 'Arreglos y Flujos de Datos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 467 )
   then
      update knowledge_resource
      set    description = 'Funciones en Programacion (Cuadrado de un num', name = 'Funciones en Programacion (Cuadrado de un num', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = FALSE
      where id = 467 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 467, now(), 'Funciones en Programacion (Cuadrado de un num', 'Funciones en Programacion (Cuadrado de un num', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 468 )
   then
      update knowledge_resource
      set    description = 'Funciones en programacion II', name = 'Funciones en programacion II', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 468 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 468, now(), 'Funciones en programacion II', 'Funciones en programacion II', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 469 )
   then
      update knowledge_resource
      set    description = 'Funciones en Programacion (Area de un Circulo', name = 'Funciones en Programacion (Area de un Circulo', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 469 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 469, now(), 'Funciones en Programacion (Area de un Circulo', 'Funciones en Programacion (Area de un Circulo', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 470 )
   then
      update knowledge_resource
      set    description = 'Programacion Area de un Circulo', name = 'Programacion Area de un Circulo', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 470 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 470, now(), 'Programacion Area de un Circulo', 'Programacion Area de un Circulo', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 471 )
   then
      update knowledge_resource
      set    description = 'Funciones de mas de un parametro', name = 'Funciones de mas de un parametro', resource_type = 'pdf', 
      last_update_date = now(), url = '', last_user_edit = 0,
      quiz_id = null, enable = TRUE
      where id = 471 ; 
   else
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 471, now(), 'Funciones de mas de un parametro', 'Funciones de mas de un parametro', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 472 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 472, now(), 'Funciones en Programacion (Cuadrado de un num', 'Funciones en Programacion (Cuadrado de un num', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 474 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 474, now(), 'ejercicios_logica', 'ejercicios_logica', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 480 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 480, now(), 'ejercicios_cap_logica', 'ejercicios_cap_logica', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 486 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 486, now(), 'ejercicios_cap_conjuntos', 'ejercicios_cap_conjuntos', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 490 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 490, now(), 'ejercicios_cap_relaciones_funciones', 'ejercicios_cap_relaciones_funciones', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 496 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 496, now(), 'ejercicios_cap_intro_lenguajes', 'ejercicios_cap_intro_lenguajes', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 500 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 500, now(), 'ejercicios_cap_conjuntos', 'ejercicios_cap_conjuntos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 509 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 509, now(), 'ejercicios_cap_func_prog', 'ejercicios_cap_func_prog', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 510 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 510, now(), 'ejercicios_cap_intro_lenguajes', 'ejercicios_cap_intro_lenguajes', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 515 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 515, now(), 'ejercicios_cap_intro_lenguajes', 'ejercicios_cap_intro_lenguajes', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 531 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 531, now(), 'ejercicios_cap_flujos', 'ejercicios_cap_flujos', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 534 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 534, now(), 'ejercicios_cap_flujos', 'ejercicios_cap_flujos', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 538 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 538, now(), 'ejercicios_cap_recursion', 'ejercicios_cap_recursion', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 541 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 541, now(), 'ejercicios_cap_cadenas', 'ejercicios_cap_cadenas', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 544 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 544, now(), 'ejercicios_cap_matrices', 'ejercicios_cap_matrices', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 546 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 546, now(), 'ejercicios_cap_cadenas', 'ejercicios_cap_cadenas', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 548 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 548, now(), 'ejercicios_cap_ciclos', 'ejercicios_cap_ciclos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 550 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 550, now(), 'ejercicios_cap_arreglos', 'ejercicios_cap_arreglos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 552 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 552, now(), 'ejercicios_cap_matrices', 'ejercicios_cap_matrices', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 556 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 556, now(), 'ejercicios_cap_cadenas', 'ejercicios_cap_cadenas', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 576 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 576, now(), 'ejercicios_cap_flujos', 'ejercicios_cap_flujos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 579 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 579, now(), 'ejercicios_cap_relaciones_funciones', 'ejercicios_cap_relaciones_funciones', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 581 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 581, now(), 'ejercicios_cap_func_prog', 'ejercicios_cap_func_prog', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 600 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 600, now(), 'ejer', 'ejer', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 610 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 610, now(), 'ejercicios_cap_logica', 'ejercicios_cap_logica', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 619 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 619, now(), 'historiadatos', 'historiadatos', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 626 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 626, now(), 'tarea_grupo_1', 'tarea_grupo_1', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 627 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 627, now(), 'tarea_grupo_2', 'tarea_grupo_2', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 632 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 632, now(), 'ejercicionormalizacion', 'ejercicionormalizacion', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 633 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 633, now(), 'tareanormalizacion', 'tareanormalizacion', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 639 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 639, now(), 'taller2', 'taller2', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 640 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 640, now(), 'taller_2', 'taller_2', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 642 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 642, now(), 'taller3vistas', 'taller3vistas', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 656 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 656, now(), 'ejercicios1', 'ejercicios1', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 689 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 689, now(), 'ejercicio', 'ejercicio', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 690 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 690, now(), 'ejercicio2', 'ejercicio2', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 697 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 697, now(), 'taller_hbase', 'taller_hbase', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 699 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 699, now(), 'tallercassandra', 'tallercassandra', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 701 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 701, now(), 'tallermongo', 'tallermongo', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 704 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 704, now(), 'normalizacion', 'normalizacion', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 706 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 706, now(), 'taller_entregable1', 'taller_entregable1', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 711 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 711, now(), 'taller_neo4j', 'taller_neo4j', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 713 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 713, now(), 'tallermapreduce', 'tallermapreduce', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 715 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 715, now(), 'taller_hadoop', 'taller_hadoop', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 716 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 716, now(), 'quiz', 'quiz', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 717 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 717, now(), 'taller2_hadoop', 'taller2_hadoop', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 718 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 718, now(), 'hadoop_vm', 'hadoop_vm', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 719 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 719, now(), 'instalacionvb', 'instalacionvb', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 721 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 721, now(), 'taller_apachepig', 'taller_apachepig', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 723 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 723, now(), 'taller_lucene', 'taller_lucene', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 727 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 727, now(), 'taller_hive', 'taller_hive', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 728 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 728, now(), 'taller_solr', 'taller_solr', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 729 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 729, now(), 'taller_solr', 'taller_solr', 'pdf', now(), '', 0, 0, null, FALSE ) ;
   end if;
if exists ( select 1 from knowledge_resource where id = 730 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 730, now(), 'taller_solr', 'taller_solr', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
...
if exists ( select 1 from knowledge_resource where id = 739 )
   then
      ...
      insert into knowledge_resource ( id, creation_date, description, name, resource_type, last_update_date, url, creator, last_user_edit, quiz_id, enable ) 
      values ( 739, now(), 'taller_vistas', 'taller_vistas', 'pdf', now(), '', 0, 0, null, TRUE ) ;
   end if;
